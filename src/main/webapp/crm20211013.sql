...
INSERT INTO `adminmail` (`adminmail`, `adminid`, `billboardid`, `createtime`) VALUES
('45a7295e2e08479fa18c555335b5aad5', 1, 7, '2021-10-12 05:29:12'),
('711f658ceb6944e68fa278108cf052db', 1, 6, '2021-10-12 08:05:35'),
('de2d84c2004040bc8a99a4aa497aa7d4', 2, 7, '2021-10-12 05:29:12');
...
INSERT INTO `billboard` (`billboardid`, `user`, `theme`, `content`, `state`, `createtime`, `endtime`, `time`, `top`, `readcount`, `billtowngroup`, `billboardgroupid`) VALUES
(1, '灰灰', '杜甫《登高》', '風急天高猿嘯哀，渚清沙白鳥飛回。\r<br>無邊落木蕭蕭下，不盡長江滾滾來。\r<br>萬里悲秋常作客，百年多病獨登台。\r<br>艱難苦恨繁霜鬢，潦倒新停濁酒杯。\r<br>', '發佈', '2021-10-08 09:03:01', NULL, NULL, '置頂', NULL, '一般公告', 'ddddfffffssssffff'),
(4, '灰灰', '將進酒 (李白)', '君不見黃河之水天上來，奔流到海不復回。\r<br>君不見高堂明鏡悲白髮，朝如青絲暮成雪。\r<br>人生得意須盡歡，莫使金樽空對月。\r<br>天生我材必有用，千金散盡還復來。\r<br>烹羊宰牛且爲樂，會須一飲三百杯。\r<br>岑夫子，丹丘生。將進酒，杯莫停。\r<br>與君歌一曲，請君爲我側耳聽。\r<br>鐘鼓饌玉不足貴，但願長醉不願醒。\r<br>古來聖賢皆寂寞，惟有飲者留其名。\r<br>陳王昔時宴平樂，斗酒十千恣讙謔。\r<br>主人何為言少錢？徑須沽取對君酌。\r<br>五花馬，千金裘。\r<br>呼兒將出換美酒，與爾同銷萬古愁。 ', '發佈', '2021-10-12 02:09:07', NULL, NULL, '', NULL, '生產', '1248a83952314bc38e270b4b57a4b45e'),
(5, '灰灰', '丑奴儿', '少年不識愁滋味，愛上層樓。愛上層樓。爲賦新詞強說愁。\r<br>而今識盡愁滋味，欲說還休。欲說還休。卻道天涼好個秋。', '發佈', '2021-10-08 03:38:09', NULL, NULL, '', NULL, '一般公告', 'ddddfffffssssffff'),
(6, '灰灰', '木蘭辭(納蘭性德)', '人生若只如初見，何事秋風悲畫扇。\r<br>等閒變卻故人心，卻道故人心易變。\r<br>驪山語罷清宵半，淚雨霖鈴終不怨。\r<br>何如薄倖錦衣郎，比翼連枝當日願。\r<br>', '發佈', '2021-10-12 05:25:50', NULL, NULL, '', NULL, '生產', '01dasgregrehvbcvddd生產'),
(7, '灰灰', '李煜《虞美人·春花秋月何时了》', '春花秋月何時了？往事知多少。\r<br>小樓昨夜又東風，故國不堪回首月明中。\r<br>雕欄玉砌應猶在，只是朱顏改。\r<br>問君能有幾多愁？恰似一江春水向東流。', '發佈', '2021-10-12 05:29:12', NULL, NULL, '', NULL, '一般公告', 'a56d081ef7334f6f957f24ae49ad1454');
...
--
-- 傾印資料表的資料 `billboardgroup`
--

INSERT INTO `billboardgroup` (`billboardgroupid`, `billboardgroup`, `billboardoption`) VALUES
('01dasgregrehvbcvaaa研發', '研發', '全部'),
('01dasgregrehvbcvbbb業務', '業務', '全部'),
('01dasgregrehvbcvccc行銷', '行銷', '全部'),
('01dasgregrehvbcvddd生產', '生產', '全部'),
('01dasgregrehvbcvfggg採購', '採購', '全部'),
('01dasgregrehvbcv一般公告', '一般公告', '全部'),
('1248a83952314bc38e270b4b57a4b45e', '生產', 'sss'),
('a56d081ef7334f6f957f24ae49ad1454', '一般公告', 'AAA'),
('ddddfffffssssffff', '一般公告', '停產');
...
('1e34614093074c1dac7c50f79f666c0f', 4, '灰灰', '2021-10-12 07:43:03'),
('637f0fbba70c4921b8fa3ef8b2153364', 7, '1', '2021-10-12 07:54:46'),
('6b8649b7688e4ce1b42cfa6c8ab863e5', 5, '灰灰', '2021-10-12 07:43:24'),
('c250457215c54ac9b1b4a6d7108bd165', 1, '灰灰', '2021-10-12 07:43:33'),
('ccccccc', 1, 'asdasda', '2021-10-06 01:56:46'),
('eb909f0f38a1477cbb76cb79cbb8f4e3', 6, '灰灰', '2021-10-12 07:43:29'),
...
--
ALTER TABLE `billboard`
  MODIFY `billboardid` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
