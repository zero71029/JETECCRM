            ...
            <div class="container-fluid">
                <div class="row justify-content-end">
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                <input type="checkbox" class="btn-check" id="btncheck1" autocomplete="off"
                                    onclick="javascript:location.href='${pageContext.request.contextPath}/system/billboard.jsp'">
                        ...
                        <div class="col-lg-5">
                            <!-- <form action="${pageContext.request.contextPath}/CRM/selectbillboard" method="post">
                                <div class="input-group mb-3" style="width: 95%; padding-left: 50px;">
                                    <input type="text" class="form-control" placeholder=" 編號 or 主題 or 發佈者 "
